// import { CategoryDto, CategoryServiceProxy, QnAAgentCategoryDto } from "./../../../../shared/service-proxies/service-proxies";
...
//     protected categoryServiceProxy: CategoryServiceProxy;
//     public projectAgentService: ProjectAgentService;
...
//         this.categoryServiceProxy = injector.get(CategoryServiceProxy);
...
//         this.populateTree();
//         this.items = [
//             { label: this.l("Edit"), icon: "la la-edit", command: (event) => this.editCategoryModel() },
//             { label: this.l("AddSubCategory"), icon: "la la-plus", command: (event) => this.createCategoryModel(false) },
//             { label: this.l("Delete"), icon: "la la-close", command: (event) => this.deleteCategory() }
//         ];
...
//         this.categoryServiceProxy.getCategoriesByAgentId(this.agentId, API_VERSION).subscribe((result) => {
...
//     public creatTreeNode(category: CategoryDto, treeNodeClass: TreeNodeClass): void {
...
//         this.categoryServiceProxy.createCategory(category, API_VERSION)
//             .subscribe((result) => {
...
//         this.categoryServiceProxy.updateCategory(category, API_VERSION)
//             .subscribe((result) => {
